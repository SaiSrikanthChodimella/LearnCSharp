...
const DotNETMemory = () => {
  return (
    <div className="p-6 bg-gray-100 text-gray-800">
      ...
      <p className="mb-4">
        .NET automatically manages memory using a Garbage Collector (GC), which
        removes objects that are no longer in use. This helps free up memory for
        new tasks. GC is part of CLR (Ref Link)
      </p>
      <Section title="Stack and Heap Memory">
        ...
        <p className="mb-2">
          Even though the stack and heap share the same memory space, they work
          differently:
        </p>
        <ul className="list-disc list-inside mb-2">
          <li>
      ...
      <Section title="How .NET Stores Data">
        <ul className="list-disc list-inside mb-2">
          ...
          <li>
            A class is stored in the heap, but a variable holding its reference
            is in the stack.
          </li>
          <li>
            Value types are stored close together in memory, making them faster
            to access. We can use special attributes to control how they are
            stored.
          </li>
          <li>
            Memory allocation (reserving space) in C# is very fast, but freeing
            up memory (deallocation) takes longer because the Garbage Collector
            has to clean up unused objects.
          </li>
          <li>
      ...
      <Section title="Why Are Loops and Method Calls Expensive?">
        <ul className="list-disc list-inside mb-2">
          ...
          <li>
            Loops and methods cause frequent memory allocations, increasing CPU
            workload.
          </li>
          <li>
      ...
      <Section title="What Are Inline Methods?">
        <ul className="list-disc list-inside mb-2">
          <li>
            Inlining is when the compiler replaces a method call with the actual
            method code to improve performance.
          </li>
          <li>
            It reduces the overhead of method calls, making execution faster.
            which simplifies memory management in .NET while keeping performance
            in mind.
          </li>
        </ul>
      </Section>
