      ...
      <div className="max-w-7xl mx-auto">
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Section title="Namespace">
            <p>
              A collection of classes, interfaces, structs, enums, and
              delegates.
            </p>
            <p>
              Using statements at the top of the code page indicate you are
              using those namespace’s classes, etc.
            </p>
          ...
          <Section title="Class and Object">
            ...
            <p>
              Classes can be static or non-static. If a class is static, its
              methods should be static.
            </p>
            <p>
              When you declare a method or field as static, it belongs to the
              class rather than an instance of the class. Instances cannot
          ...
          <Section title="Constructor">
            <p>
              A special method in a class that has the same name as the class
              and has no return type. It is used to initialize data in the
              class.
            </p>
          ...
          <Section title="Params">
            ...
            <p>{`}`}</p>
            <p>
              When calling this method, we can pass as many parameters of the
              same data type as needed.
            </p>
          </Section>
          ...
          <Section title="Recursive Method">
            ...
            <p>
              A method that calls itself repeatedly. It must have a break or
              return statement to stop the cyclic loop.
            </p>
          </Section>
        </div>
      </div>
