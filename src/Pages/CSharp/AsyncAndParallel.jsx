      ...
      <div className="w-full p-2">
        ...
        <Section title="Threads and Processes">
          <p>
            ...
            operating system. This process includes memory, system resources,
            and threads. Multiple processes can run at the same time, and the
        ...
        <Section title="ParameterizedThreadStart Delegate">
          <p>
            Allows passing a parameter to the thread’s entry point method.
