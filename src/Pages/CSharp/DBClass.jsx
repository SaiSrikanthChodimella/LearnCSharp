...
const DBClass = () => {
  ...
  public DbSet<ModelClass> ModelClass { get; set; }
      ...
      <Section title="Handling Model Changes in EF">
        ...
        <ul className="list-disc list-inside">
          <li>
            Auto-generated code maintains the database schema. Converts C# code
            to SQL queries.
          </li>
          <li>
      ...
      <Section>
        <p>
          In .NET Framework, use Global.asax to check and recreate the database
          on start. Check how to do this in .NET 7.
        </p>
        <ul className="list-disc list-inside">
          <li>
            On start, check if the database matches the model and choose to drop
