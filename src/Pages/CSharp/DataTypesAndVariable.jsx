  ...
  return (
    <div className="p-6 bg-gray-100">
      ...
      <Section title="Value Types (Stored in Stack)">
        {renderTable(valueTypes)}
      </Section>

      <Section title="Reference Types (Stored in Heap)">
        {renderTable(referenceTypes)}
      </Section>
      <InfoBox>
      ...
      <InfoBox>
        <Section title="The var Keyword in C#">
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            I always prefer using this whenever I can, but skip var when the
            right-hand side of the equation is not clear.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            For example:
            <CodeBlock>
