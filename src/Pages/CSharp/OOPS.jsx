    ...
    <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Section title="Inheritance">
        ...
        <p>
          ...
          properties like Speed, Year, Make, and Capacity. Child classes such as
          Bicycle, Car, SUV, and Bus inherit these properties while adding their
          own unique features.
        </p>
      ...
      <Section title="Polymorphism">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            abstract means the method has no implementation in the parent class,
            and the child class must override it.
          </li>
          <li>
      ...
      <Section title="Encapsulation">
        ...
        <ul className="list-disc list-inside">
          <li>
            ...
            expose them through properties or methods, ensuring the integrity of
            the data.
          </li>
          <li>
      ...
      <Section title="Interface">
        <p>
          ...
          coupling and enabling better modularity, security, and multiple
          inheritance (through interfaces).
        </p>
        <ul className="list-disc list-inside">
          <li>
            Interfaces define method signatures, properties, delegates, events,
            but not fields. The implementation of these methods is provided by
          ...
          <li>
            Access modifiers: By default, everything in an interface is public.
            You cannot specify access modifiers like private or protected.
          </li>
          <li>
            An interface can inherit from other interfaces, creating a chain of
            interfaces.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside">
          <li>
            ...
            the same signature, you can use explicit interface implementation to
            avoid conflicts. This way, methods are only accessible through the
            interface reference.
          </li>
          <li>
      ...
      <Section title="Properties">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            The setter assigns a value to the property, and often includes logic
            for validation or manipulation before setting the value.
          </li>
          <li>
            Auto-implemented properties are simpler and do not require explicit
            backing fields. C# automatically provides the backing field behind
            the scenes.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            ...
            value before setting it, or when you want to implement custom logic
