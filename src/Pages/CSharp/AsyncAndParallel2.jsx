      ...
      <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <Section title="Retrieving Data from Thread">
          ...
          <SubSection title="Thread.IsAlive">
            ...
            <p>
              Returns: true if the thread is running; false if it has finished
              or stopped.
            </p>
          </SubSection>
        ...
        <Section title="Protecting Shared Resources">
          <p>
            When multiple threads access shared resources, inconsistency can
            occur if the resources are not protected. Use synchronization
          ...
          <SubSection title="Synchronization Mechanisms">
            ...
            <SubSection title="Mutex">
              <p>
                A synchronization primitive that allows only one thread to
        ...
        <Section title="ManualResetEvent and AutoResetEvent">
          ...
          <SubSection title="Deadlock Resolution">
            <p>
              Deadlocks occur when threads wait indefinitely for resources held
              by each other.
            </p>
            <List
              items={[
