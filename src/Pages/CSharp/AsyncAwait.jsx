      ...
      <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <Section title="Sync Programming">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              New threads are created for new requests, consuming a lot of
              memory.
            </li>
          </ul>
        </Section>
        <Section title="Async Programming">
          <p>
            Async programming helps overcome the limitations of sync
            programming, especially for non-CPU bound operations.
          </p>
          <ul className="list-disc list-inside">
            <li>
        ...
        <Section title="Async and Await">
          <ul className="list-disc list-inside">
            ...
            <li>
              "Async" automatically wraps the return value in a task; use
              "await" to unwrap it.
            </li>
          </ul>
